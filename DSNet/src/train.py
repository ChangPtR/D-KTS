...
# CUDA_VISIBLE_DEVICES=2 nohup python train.py --dataset ../my_data/tvsum2_googlenet.h5 --model-dir ../models/tvsum2 --splits ../dataset_split/tvsum_splits.yml --freq 15 >/dev/null 2>log.o &
